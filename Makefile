exercises : build-dir exercise.o can-balance.o map-share.o max-span.o sort-set.o \
		string-splosion.o sum-numbers-stream.o without-string-regex.o main.o
	g++ --std=c++17 build/exercise.o build/can-balance.o build/max-span.o build/map-share.o \
		build/sort-set.o build/string-splosion.o build/sum-numbers-stream.o build/without-string-regex.o \
...
main.o : src/main.cpp include/exercise.hpp include/exercises/can-balance.hpp include/exercises/map-share.hpp \
		include/exercises/max-span.hpp include/exercises/sort-set.hpp include/exercises/string-splosion.hpp \
...
sort-set.o : src/exercises/sort-set.cpp include/exercise.hpp include/exercises/sort-set.hpp
	g++ -c --std=c++17 src/exercises/sort-set.cpp -Iinclude -o build/sort-set.o
